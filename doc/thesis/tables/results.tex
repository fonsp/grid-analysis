\begin{tabular}{lll|rrl|lc}
\toprule
\multicolumn{3}{c}{\textsc{Overload probability}} & \multicolumn{3}{c}{\textsc{Most likely injection}} & \multicolumn{2}{c}{\textsc{Cascade}} \\
\midrule
$l$ & $\PROB \left[ |\mel{f}_l| \geq 1 \right]$ & \multicolumn{1}{p{3em}}{mean $\pm$SD} & \multicolumn{1}{p{5em}}{\centering total {fluctuation}} & \multicolumn{2}{p{7em}}{extended buses (add. capacity)} & \multicolumn{1}{p{12em}}{\centering failed lines per phase \\ (disconnected)} & \multicolumn{1}{p{3em}}{\centering power \\ island?}\\
\midrule
