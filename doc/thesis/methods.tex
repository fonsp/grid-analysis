...
\towrite{Plotjes van windreeksen en zonnereeksen, zoals ik in februari/maart heb laten zien.}
\subsection{ARMA model}
\towrite{wat is het gebruikte arma model?}
